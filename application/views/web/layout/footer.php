...
<!-- Histats.com  END  -->
		...
		<div class="copyright-agiles py-3">
			<div class="container">
				<div class="row">
					<p class="col-lg-8 copy-right-grids text-white text-lg-left text-center mt-lg-1">© 2018 <a href="https://w3layouts.com/" target="_blank">SMK Pasim Plus Kota Sukabumi</a>
					</p>
					<!-- social icons -->
