				...
				<div class="collapse navbar-collapse text-center" id="navbarSupportedContent">
					<ul class="navbar-nav justify-content-center">
						...
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu">
								<a class="dropdown-item" href="<?= base_url('pendaftaran') ?>">PSB Online <?php echo date('Y') ?></a>
						...
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu">
								<a class="dropdown-item" href="<?php echo base_url()?>gallery">Galeri Foto</a>
								<a class="dropdown-item" href="<?php echo base_url()?>video">Galeri Video</a>
							</div>
						</li>
						<li class="nav-item">
