			...
			<div class="row contact-grids agile-1 py-sm-5 pb-sm-0 pb-5">
				<div class="col-sm-4 contact-grid agileinfo-6 mt-sm-0 mt-2">
					<div class="contact-grid1 text-center">
						...
						<h4 class="font-weight-bold mt-sm-4 mt-3 mb-3">Alamat</h4>
						<p>Jalan Prana No.8A, Cikole, Kota Sukabumi, Jawa Barat
						</p>
					</div>
				</div>
				<div class="col-sm-4 contact-grid agileinfo-6 my-sm-0 my-4">
					<div class="contact-grid1 text-center">
						...
						<h4 class="font-weight-bold mt-sm-4 mt-3 mb-3">Telp</h4>
						<p>(0266) 241000</p>
					</div>
				</div>
				<div class="col-sm-4 contact-grid agileinfo-6">
					<div class="contact-grid1 text-center">
						...
						<p>
							<a href="mailto:info@example.com">info@smkpasimplus.sch.id</a>
						</p>
					</div>
				</div>
			</div>
