	...
	<div class="about py-5">
		<div class="container py-xl-5 py-lg-3">
			<h3 class="title text-capitalize font-weight-light text-dark text-center mb-5">Welcome to
				<span class="font-weight-bold">SMK Pasim Plus</span>
			</h3>
			<div class="row pt-md-4">
				...
				<div class="col-lg-6 left-img-agikes mt-lg-0 mt-sm-4 mt-3 text-right">
					<img src="<?= base_url('assets/kepsek.jpg') ?>" alt="" class="img-fluid" />
				</div>
			</div>
		</div>
	</div>
	...
	<div class="classes py-5">
		<div class="container py-xl-5 py-lg-3">
			<h3 class="title text-capitalize font-weight-light text-dark text-center mb-sm-5 mb-4">
				<span class="font-weight-bold">Galeri</span>
			</h3>
			<div class="row pt-4">
				...
				<div class="col-lg-3 col-news-top text-center">
					...
					<div class="ih-item circle effect16 left_to_right mx-auto">
						<a href="<?= base_url('Gallery/lihatgaleri/'.$glr->kategori)?>">
							<div class="img">
								<img src="<?= base_url('assets/upload/galeri/').$glr->gambar ?>" alt="img" class="img-fluid rounded-circle">
							</div>
							<div class="info">
								<h3 class="text-capitalize text-white"><?= $glr->kategori ?></h3>
							</div>
						</a>
					</div>
					<h6 class="small-heading text-capitalize text-center mt-4">
						<a href="<?= base_url('Gallery/lihatgaleri/'.$glr->kategori)?>" class="text-dark"><?= $glr->kategori ?>
							<i class="fas fa-long-arrow-alt-right ml-1"></i>
						</a>
					</h6>
					<!-- end normal -->
