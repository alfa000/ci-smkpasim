...
class Home extends CI_Controller {
	...
	{
		parent::__construct();
		$this->load->model(array('Gurumodel','Siswamodel','Beritamodel','Galerimodel','Slidemodel','Prestasimodel','Jurusanmodel','Profilmodel','Videomodel'));
	...
	public function index()
	{
		...
		//$home['kategori'] = $this->Beritamodel->get_kategori_brt();
